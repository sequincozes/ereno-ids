...
import static legacy.substation.Parameters.NORMALIZE;
import static legacy.substation.Util.readDataFile;
...
//        avaliarESelecionar(14, METODO.OneR, false); 
    ...
    GeneralParameters.ALL_IN_ONE_FILE  = "/home/silvio/datasets/wsn-ds/blackhole/train_5.csv";
    ...
    public static FeatureAvaliada[] avaliarESelecionar(int featuresSelecionar, METODO metodo, boolean debug) throws Exception {
        ...
        Instances instances = new Instances(readDataFile(GeneralParameters.ALL_IN_ONE_FILE));
