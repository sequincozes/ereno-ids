...
public class CicidsFeatures {
    ...
    public static final int[] GRASP_VND_IWSSR[] = {GRASP_VND_IWSSR_RandomTree, GRASP_VND_IWSSR_J48, GRASP_VND_IWSSR_RepTree, GRASP_VND_IWSSR_NaiveBayes, GRASP_VND_IWSSR_RandomForest};

    public static final int[] GRASP_VND_IG_RandomTree = new int[]{36, 76, 67, 43, 68};
    public static final int[] GRASP_VND_IG_J48 = new int[]{73, 67, 1, 43, 68};
    public static final int[] GRASP_VND_IG_NaiveBayes = new int[]{1, 7, 40, 66, 67};
    public static final int[] GRASP_VND_IG_RandomForest = new int[]{76, 1, 67, 70, 40};
    public static final int[] GRASP_VND_IG_RepTree = new int[]{1, 67, 73, 36, 40};
    ...
    public static final int[] GRASP_RVND_IG_RandomTree = new int[]{8, 14, 6, 67, 14};
    public static final int[] GRASP_RVND_IG_J48 = new int[]{14, 8, 6, 66, 67};
    public static final int[] GRASP_RVND_IG_NaiveBayes = new int[]{1, 7, 13, 67, 36};
    public static final int[] GRASP_RVND_IG_RandomForest = new int[]{8, 14, 6, 67, 14};
    public static final int[] GRASP_RVND_IG_RepTree = new int[]{14, 8, 6, 66, 6};
